...
from wp_publisher import create_post, load_published, save_published
...
def publish_record(record: dict) -> str | None:
    ...
    try:
        result = create_post(post["title"], html, categories=categories)
